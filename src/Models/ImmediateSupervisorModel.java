...
/**
 * Enhanced ImmediateSupervisor Model Class - extends EmployeeModel and handles team management
 * Focuses on supervising direct reports, approving leave/overtime requests,
 * and monitoring team performance
 * Author Chadley
 */
public class ImmediateSupervisorModel extends EmployeeModel {
     ...
     */
    public ImmediateSupervisorModel(int employeeId, String firstName, String lastName, String email, String userRole) {
     ...
     */
    public ImmediateSupervisorModel(EmployeeModel employee, String department) {
        super();
        ...
        System.out.println("ImmediateSupervisor initialized from EmployeeModel: " + getFullName() + 
            " - Department: " + this.department);
    }

    /**
     * Constructor from existing EmployeeModel without department
     */
    public ImmediateSupervisorModel(EmployeeModel employee) {
        this(employee, null);
    }
    ...
    public String toString() {
        return "ImmediateSupervisorModel{" +
