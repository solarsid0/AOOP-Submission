...
/**
 * Enhanced IT Model Class - extends EmployeeModel and handles system administration
 * Focuses on user management, system maintenance, database operations, and security
 */
public class ITModel extends EmployeeModel {
    ...
    /**
     * Constructor for IT role - calls parent EmployeeModel constructor
     */
    public ITModel(int employeeId, String firstName, String lastName, String email, String userRole) {
    ...
    /**
     * Full constructor if you have complete employee data
     */
    public ITModel(EmployeeModel employee) {
        // Copy all fields from the employee model
        super();
        this.copyFromEmployeeModel(employee);
        
        // Initialize IT-specific components
        this.databaseConnection = new DatabaseConnection();
        this.employeeDAO = new EmployeeDAO(databaseConnection);
        this.userAuthDAO = new UserAuthenticationDAO();
        
        System.out.println("IT user initialized from EmployeeModel: " + getFullName());
    }
    ...
    private void copyFromEmployeeModel(EmployeeModel source) {
        ...
        // Add more fields as your EmployeeModel expands
    }
