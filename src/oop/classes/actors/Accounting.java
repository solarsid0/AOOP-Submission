...
/**
 * Enhanced Accounting Role Class - integrates with Services layer
...
public class Accounting extends User {
     ...
     */
    public Accounting(int employeeId, String firstName, String lastName, String email, String userRole) {
